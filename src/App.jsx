...
function App() {
  ...
  return (
    <>
      ...
      {error ? (
        <main className="wrapper text-center flow">
          <img src={ErrorIcon} alt="" />
          <h1 className="main-title  text-center">Something went wrong</h1>
          <p>We couldn’t connect to the server (API error). Please try again in a few moments. Please refresh the page to try again</p>
        </main>
      ) : (
        <main className="wrapper flow-lg">
          ...
          {data ? (
            ...
            <section className="current loading-state bg-surface-400 br-lg fs-lg flex-flow align-center justify-center">
          ...
          {data ? (
            ...
            <section className="daily loading-state bg-surface-400 br-lg fs-lg flex-flow align-center justify-center">
              <img src={LoadingIcon} alt="" />
              <p>Loading...</p>
            </section>
          )}
          ...
          {data ? (
            ...
            <section className="hourly loading-state bg-surface-400 br-lg fs-lg flex-flow align-center justify-center">
              <img src={LoadingIcon} alt="" />
              <p>Loading...</p>
            </section>
          )}
